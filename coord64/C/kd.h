...
extern int kd_nearest (kd_tree tree, long long x, long long y, int m, kd_priority **alist);
extern void kd_print_nearest (kd_tree tree, long long x, long long y, int m);
