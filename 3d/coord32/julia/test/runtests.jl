using KDTree3D32
using Test
import KDTree3D32: insert!, search, nearest, count_items, is_member, hard_delete!, delete!, build_tree, rebuild!, badness

@testset "KDTree3D32 basic tests" begin
    tree = Tree{Int32}()
...
@testset "KDTree3D32 Really Delete & Badness & Nearest" begin
    import KDTree3D32: really_delete!
    using Random
    tree = Tree{Int32}()
    Random.seed!(42)
