...
extern int kd_nearest (kd_tree tree, int x, int y, int z, int m, kd_priority **alist);
extern void kd_print_nearest (kd_tree tree, int x, int y, int z, int m);
