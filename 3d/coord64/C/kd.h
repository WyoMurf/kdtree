...
typedef long long kd_box[6];
typedef long long *kd_box_r;
...
typedef struct KDElem {
    ...
    long long lo_min_bound;             /* Lower minimum boundary   */
    long long hi_max_bound;             /* High maximum boundary    */
    long long other_bound;              /* Discriminator dependent  */
...
extern int kd_nearest (kd_tree tree, long long x, long long y, long long z, int m, kd_priority **alist);
extern void kd_print_nearest (kd_tree tree, long long x, long long y, long long z, int m);
