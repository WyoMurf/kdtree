...
impl Lcg {
    ...
    fn next_u64(&mut self) -> u64 {
        let h = self.next() as u64;
        let l = self.next() as u64;
        (h << 32) | l
    }
}
...
fn main() {
    ...
    for i in 0..n_boxes {
        let x1 = (rng.next_u64() % 10_000_000_000) as i64;
        let y1 = (rng.next_u64() % 10_000_000_000) as i64;
        let z1 = (rng.next_u64() % 10_000_000_000) as i64;
        let x2 = x1 + (rng.next_range(100) as i64) + 1;
        let y2 = y1 + (rng.next_range(100) as i64) + 1;
        let z2 = z1 + (rng.next_range(100) as i64) + 1;
    ...
    let search_area: KdBox = [0, 0, 0, 5_000_000_000, 5_000_000_000, 5_000_000_000];
