...
func (t *Tree) Nearest(x, y, z int64, m int) []Priority {
	if t.Root == nil || m <= 0 {
		return nil
	}
	...
	Xq := Box{x, y, z, x, y, z}
	Bp := Box{math.MaxInt64, math.MaxInt64, math.MaxInt64, math.MaxInt64, math.MaxInt64, math.MaxInt64}
	Bn := Box{math.MinInt64, math.MinInt64, math.MinInt64, math.MinInt64, math.MinInt64, math.MinInt64}
