# 3D KD-Tree (C Implementation)

This directory contains the unified C implementation of a 3D KD-Tree, supporting both 32-bit and 64-bit coordinate data types dynamically at compile time.
...
- `kd_3d_32_create()` / `kd_3d_64_create()`
- `kd_3d_32_insert()` / `kd_3d_64_insert()`
- `kd_3d_32_nearest()` / `kd_3d_64_nearest()`
