# 2D KD-Tree (Go Implementation)

This directory contains the unified Go implementation of a 2D KD-Tree, parameterized using Go Generics to support integer coordinate widths.
