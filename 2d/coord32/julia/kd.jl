...
function nearest(tree::Tree{T}, x::Int, y::Int, m::Int) where T
    ...
    xq_box = (x, y, x, y)
    bp = [2147483647 for _ in 1:4]
    bn = [-2147483647 for _ in 1:4]
...
function kd_neighbor!(node::Node{T}, xq::Box, m::Int, list::Vector{Priority{T}}, bp::Vector{Int}, bn::Vector{Int}) where T
    stack = Tuple{Node{T}, Int, Int, Vector{Int}, Vector{Int}}[]
...
function bounds_overlap_ball(xq::Box, bp::Vector{Int}, bn::Vector{Int}, m::Int, list::Vector{Priority{T}}) where T
    sum_dist = 0.0
