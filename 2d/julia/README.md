...
This directory contains the unified Julia implementation of a 2D KD-Tree, relying on Julia's parametric types and multiple dispatch to support both 32-bit and 64-bit coordinate widths seamlessly.
