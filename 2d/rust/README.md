...
This directory contains the unified Rust implementation of a 2D KD-Tree, parameterized using Rust Generics and Traits to support both `i32` and `i64` coordinate widths dynamically.
